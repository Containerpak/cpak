...
func intersectOverrides(parent, child types.Override) types.Override {
	return types.Override{
		...
		Clipboard: types.ClipboardGrant{
			HostToApp: parent.Clipboard.HostToApp && child.Clipboard.HostToApp,
			AppToHost: parent.Clipboard.AppToHost && child.Clipboard.AppToHost,
		},
